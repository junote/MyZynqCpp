...
class PMBus:
    ...
    def _writeBytePMBus(self, cmd, byte):
        write_buf = i2c_msg.write(self.devAddr, [cmd, byte])
        with SMBusWrapper(self.busID) as bus:
            bus.i2c_rdwr(write_buf)
    ...
    def clearFaults(self):
        ...
        # signal output if the device is asserting
        device negates (clears, releases) its SMBALERT
